...
- **Button** — 4 variants, 3 sizes, 5 states (default/hover/pressed/disabled/loading), hug sizing, prototype interactions, Figma + web. Icon text property key: `Icon2#579:0` (TEXT, default 'add'). Boolean show/hide property: `Icon#89:0`. Label text property: `Label2#250:0`. **Icon nodes use Material Icons Regular** (no fontFamily variable binding) — required for Plugin API instance insertion. Change to Material Symbols Rounded in Figma UI after builds; then apply `icon / sm/md/lg` text style.
